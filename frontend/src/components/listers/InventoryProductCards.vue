    ...
    <div>
            ...
            <v-row>
                <v-list-item class="d-flex">
                    <v-list-item-avatar
                        ...
                        class="border-color"
                    >
                        <span class="material-symbols-outlined" style="font-size:60px; color:#9575CD;">icon_font_name_for_product</span>
                    </v-list-item-avatar>
                    <h1 class="align-self-center ml-3">상품</h1>
                    <div class="secondary-text-color" style="margin-left:30px;">상품에 관한 설명</div>
                </v-list-item>
            </v-row>
        </v-card>
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <InventoryProduct :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <InventoryProduct :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
